...
function main() {
    ...
    Session.Output("============================================");
    Session.Output("User Registration Sequence Diagram Generator");
    Session.Output("============================================");
    Session.Output("");
    ...
    var diagram = sequencePackage.Diagrams.AddNew("User Registration", "Sequence");
    diagram.Update();

    Session.Output("  ✔ Diagram created: User Registration");
    Session.Output("");
    ...
    var lifelineNames = ["User", "RegistrationUI", "AuthController", "UserService", "Database"];
    ...
    var messages = [
        { from: "User", to: "RegistrationUI", message: "1: enterRegistrationDetails(email, password, username)", type: "Synchronous" },
        { from: "RegistrationUI", to: "AuthController", message: "2: register(email, password, username)", type: "Synchronous" },
        { from: "AuthController", to: "UserService", message: "3: validateEmail(email)", type: "Synchronous" },
        { from: "UserService", to: "Database", message: "4: checkEmailExists(email)", type: "Synchronous" },
        { from: "Database", to: "UserService", message: "5: emailAvailable(true)", type: "ReturnMessage" },
        { from: "UserService", to: "AuthController", message: "6: validationSuccess", type: "ReturnMessage" },
        { from: "AuthController", to: "UserService", message: "7: hashPassword(password)", type: "Synchronous" },
        { from: "UserService", to: "AuthController", message: "8: passwordHash(hash)", type: "ReturnMessage" },
        { from: "AuthController", to: "UserService", message: "9: createUser(email, hash, username)", type: "Synchronous" },
        { from: "UserService", to: "Database", message: "10: insertUser(userData)", type: "Synchronous" },
        { from: "Database", to: "UserService", message: "11: userId(12345)", type: "ReturnMessage" },
        { from: "UserService", to: "AuthController", message: "12: userCreated(true)", type: "ReturnMessage" },
        { from: "AuthController", to: "RegistrationUI", message: "13: registrationSuccess", type: "ReturnMessage" },
        { from: "RegistrationUI", to: "User", message: "14: displaySuccessMessage", type: "Synchronous" }
    ];
    ...
    Session.Output("  ✔ Sequence Diagram: User Registration");
    Session.Output("  ✔ 5 Lifelines created");
    Session.Output("  ✔ 14 Messages created");
    Session.Output("");
